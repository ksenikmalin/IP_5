...
class Type_of_work(models.Model):
    naimenovaniye = models.CharField("Наименование", max_length=150)
    cost_of_work = models.IntegerField("Стоимость типа работы за кв/м")
...
class Services(models.Model):
    naimenovaniye = models.CharField("Наименование", max_length=150)
    range_prices = models.CharField("Диапозон цены", max_length=150)
   
    id_repair_type = models.ForeignKey(Repair_type, verbose_name="Вид работы", on_delete=models.SET_NULL, null=True)
    id_type_of_work = models.ForeignKey(Type_of_work, verbose_name="Тип работы", on_delete=models.SET_NULL, null=True)
...
class Order(models.Model):
    ...
    price = models.IntegerField("Площадь")
