...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('repairs', '0005_auto_20210108_1318'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('naimenovaniye', models.CharField(max_length=150, verbose_name='Наименование')),
                ('cost_of_work', models.IntegerField(verbose_name='Стоимость типа работы за кв/м')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='repairs.type_of_work', verbose_name='Тип работы'),
        ),
        migrations.AddField(
            model_name='reviews',
            name='id_client',
        ...
        migrations.AddField(
            model_name='back_call',
            name='id_call_application_status',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='repairs.call_application_status', verbose_name='Статус заявки на обратный звонок'),
        ),
    ]
