...
from .models import Сlient, Order_status, Object, Repair_type, Type_of_work, Duration, Services, Files, Portfolio, Reviews, Order, Back_call, Call_application_status
...
class Repair_typeAdmin(ImportExportModelAdmin):
    list_display = ("naimenovaniye", "cost_of_work")
    pass
  
@admin.register(Type_of_work)
class Type_of_workAdmin(ImportExportModelAdmin):
    list_display = ("naimenovaniye", "cost_of_work")
    pass
...
class ServicesAdmin(ImportExportModelAdmin):
    list_display = ("naimenovaniye", "range_prices", "id_repair_type", "id_type_of_work", "id_object", "id_duration")
    pass
